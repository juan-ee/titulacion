...
app.get('/',function (req,res) {
    ...
    Promise.all(promises).then(function (restaurants) {
        res.render('map',{array:tours,restaurants:[].concat.apply([],restaurants)});
    });
});
